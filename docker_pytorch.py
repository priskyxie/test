...
if __name__ == "__main__":
    ...
    ### BKC 2097
    #DOCKER_IMAGE = "202d9e15d5e4"
	# BKC 2166
    DOCKER_IMAGE = "f3a6652378ba"
    EXEC_SCRIPT_PATH = "/usr/bin/python3.6 /root/pytorch_benchmark/micro_benchmarking_pytorch.py"
    PARAMETERS = "--network resnext101 --batch-size 256 --iterations 10000 --device_ids=0,1,2,3 --dataparalle"
    py = PYTORCH(DOCKER_IMAGE, EXEC_SCRIPT_PATH, PARAMETERS)
    py.run()
